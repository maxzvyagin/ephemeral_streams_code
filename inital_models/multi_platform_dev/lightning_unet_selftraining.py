...
if __name__ == "__main__":
    ...
    while model.test_loss > 0.05:
        ...
        unlabelled = preprocess.UnlabelledGISDataset(f, IMAGE_TYPE, LARGE_IMAGE, num_images=500)
        ...
        for x in range(len(unlabelled)):
            ...
            # also need to do some post processing here, get the confidence for each class and create the mask
