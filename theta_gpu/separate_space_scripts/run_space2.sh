...
python ~/ephemeral_streams_code/theta_gpu/theta_running.py -m run -s 2 -o test.csv
python ~/ephemeral_streams_code/theta_gpu/theta_running.py -m run -s 3 -o test.csv