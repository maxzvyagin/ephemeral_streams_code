...
python ~/ephemeral_streams_code/theta_gpu/theta_running.py -m run -s 0 -o ten_trials.csv
python ~/ephemeral_streams_code/theta_gpu/theta_running.py -m run -s 1 -o ten_trials.csv
