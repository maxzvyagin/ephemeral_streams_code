...
python ~/ephemeral_streams_code/theta_gpu/theta_running.py -m run -s 4 -o test.csv
python ~/ephemeral_streams_code/theta_gpu/theta_running.py -m run -s 5 -o test.csv