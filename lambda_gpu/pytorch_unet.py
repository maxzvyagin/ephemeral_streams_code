...
class PyTorch_UNet(pl.LightningModule):
    def __init__(self, config, classes, in_channels=1, model_type="deeplabv3", image_type="veg_index"):
        ...
        self.precision_metric = torchmetrics.Precision(num_classes=1)
        self.recall_metric = torchmetrics.Recall(num_classes=1)
...
if __name__ == "__main__":
    ...
    test_config = {'batch_size': args.batch_size, 'learning_rate': 0.00005, 'epochs': 50}
