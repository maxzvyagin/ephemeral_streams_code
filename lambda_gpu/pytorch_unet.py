...
class PyTorch_UNet(pl.LightningModule):
    def __init__(self, config, classes, in_channels=3, model_type="deeplabv3", image_type="veg_index"):
        ...
        self.model = smp.MAnet(encoder_name="inceptionv4", encoder_weights=None, in_channels=in_channels, classes=classes)
...
if __name__ == "__main__":
    ...
    test_config = {'batch_size': args.batch_size, 'learning_rate': .0001, 'epochs': 25}
